...
<div id="content">
    <!--breadcrumbs-->
     <div id="content-header">
        <div id="breadcrumb"><a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Add new purchase</a></div>
    </div>
    <!--End-breadcrumbs-->
    ...
    {  
      ...
      mysqli_query($link,"insert into `purchase_master` VALUES (Null,'$company_name','$product_name','$unit','$packing_size','$quantity','$price','$party_name','$payment_type','$expiry_date', '$today_date', '$_SESSION[user]')") or die(mysqli_error($link));
